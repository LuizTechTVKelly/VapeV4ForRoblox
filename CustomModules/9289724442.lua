...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/LuizTechTVKelly/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/LuizTechTVKelly/whitelists/main/whitelist2.json", true))
end)
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/LuizTechTVKelly/VapeV4ForRoblox/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/LuizTechTVKelly/VapeV4ForRoblox/wiki/Turning-on-Highlights")
