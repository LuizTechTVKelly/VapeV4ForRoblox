...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			local commit = "main"
			for i,v in pairs(game:HttpGet("https://github.com/LuizTechTVKelly/whitelists"):split("\n")) do 
			...
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/LuizTechTVKelly/whitelists/"..commit.."/whitelist2.json", true))
